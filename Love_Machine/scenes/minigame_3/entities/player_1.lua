...
Player = Class{
	...
	self.ball.force = 0
	self.ball.img = love.graphics.newImage( "scenes/minigame_3/img/ball.png" )
	self.ball.angle = 0
...
function Player:update(dt)
	...
	if self.ball.ground_bounce == self.ball.ground_bounce_max then
	 ...
	 self.ball.angle = self.ball.body:getAngle( )
...
function Player:draw()
	...
	love.graphics.draw(self.ball.img, self.ball.body:getX(), self.ball.body:getY(), self.ball.angle, 1, 1, self.ball.r, self.ball.r)
