...
function minigame_5:init()
	...
	self.intro_sounds = { love.audio.newSource( "scenes/minigame_5/sound/intro_1.ogg", "static"),
						  love.audio.newSource( "scenes/minigame_5/sound/intro_2.ogg", "static"),
						  love.audio.newSource( "scenes/minigame_5/sound/intro_3.ogg", "static"),
						  love.audio.newSource( "scenes/minigame_5/sound/intro_4.ogg", "static")}
						 
	
	self.choose_timer = 0
	self.choose_timer_max = 5
	self.choose_music =  love.audio.newSource( "scenes/minigame_5/sound/bg_sound_minigame_5.ogg", "static")
	
	self.reveal_music = love.audio.newSource( "scenes/minigame_5/sound/riser.ogg", "static")
	self.reveal_timer = 0 
