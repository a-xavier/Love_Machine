	...
	if self.phase == "active" then
		...
		--Lots of things happenn here
			...
			for k, v in pairs(player_1_logs) do
				table.insert(self.reveal_tweens, self.tween.new(self.reveal_timer_max, v, {y= v.y - max_tower + self.log_v.h}, 'inOutExpo'))
			end
			...
			table.insert(self.reveal_tweens, self.tween.new(self.reveal_timer_max, self.p1_anim, {y= self.p1_anim.y - max_tower +  self.log_v.h }, 'inOutExpo'))
			table.insert(self.reveal_tweens, self.tween.new(self.reveal_timer_max, self.p2_anim, {y= self.p2_anim.y - max_tower +  self.log_v.h }, 'inOutExpo'))
		end
	end
